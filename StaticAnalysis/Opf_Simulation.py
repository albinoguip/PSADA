...
class Opf_Simulation():
    ...
    def __init__(self, path, nome, pathtosave, GerDSAFile=False):
            ...
            for archivo in nomespwf:
                try: 
                    ...
                    if not os.path.exists(ruta_archivo_destino):
                        ...
                        print(f'Arquivo {archivo} copiado com sucesso para {path_to_output}')
                    else:
                        print(f'Arquivo {archivo} já existe em {path_to_output}')
    ...
    def HVDCchanger(self):
        ...
        csv_file = r"StaticAnalysis/RECURSOS/hvdc info.csv"
        elos_cc = []
